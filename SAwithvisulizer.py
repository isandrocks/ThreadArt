...
def string_art(output_dir, N_PINS, MAX_LINES, MIN_LOOP, MIN_DISTANCE, LINE_WEIGHT, FILENAME, SCALE, img):
...
# Main thread path calculation loop
    ...
    fill=0, width=1)
        ...
        pin = best_pin
    return length,result,line_sequence,dwg,path,frames,line_number,current_absdiff
...
def main():
    ...
    length, result, line_sequence, dwg, path, frames, line_number, current_absdiff = string_art(output_dir, N_PINS, MAX_LINES, MIN_LOOP, MIN_DISTANCE, LINE_WEIGHT, FILENAME, SCALE, img)
